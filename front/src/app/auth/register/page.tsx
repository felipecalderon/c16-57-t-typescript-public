...
const formSchema = z.object({
    emailAddress: z.string().email({message:"Debe ser un email valido"}),
            ...
            <div className="flex rounded-3xl bg-white">
                ...
                <div className="w-96 h-96 bg-green-400 rounded-3xl">
                    <div className="h-72 flex items-center flex-col justify-center gap-3">
                        <h2 className="text-2xl font-bold text-cyan-900">Bienvenido a MITI!</h2>
                        <div>
                            <p className="inline font-semibol text-teal-900">¿Ya tienes cuenta? </p>              
                            <Link 
                            href="/auth/login"
